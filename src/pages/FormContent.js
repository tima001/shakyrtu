...
const Card = styled.div`
  ...
  background: #fff;
  border-radius: 16px;
  box-shadow: 0 4px 14px rgba(109, 74, 109, 0.12);
  border: 1.5px solid ${(p) => (p.active ? "#3a204b" : "transparent")};
  cursor: pointer;
...
const Dot = styled.div`
  ...
  flex-shrink: 0;
  border: 1.5px solid #3a204b;
  background: ${(p) => (p.active ? "#3a204b" : "transparent")};
...
const SubmitBtn = styled.button`
  ...
  cursor: pointer;
  transition: all 0.3s;
  &:hover { background: #2c1638; transform: translateY(-2px); }
