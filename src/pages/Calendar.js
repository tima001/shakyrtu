...
import FloralLarge from "../img/эти фото/цветы 1.webp";

const DAYS = ["ДС", "СС", "СР", "БС", "ЖМ", "СБ", "ЖС"];
const TOTAL_DAYS = 31;
const FIRST_DAY = 3; // Oct 1 2026 = Thursday (0=Mon)
const WEDDING_DAY = 4;
...
const DayCell = styled.div`
  ...
  font-size: 16px;
  color: ${(p) => (p.highlight ? "#6d4a6d" : "#3a204b")};
  width: 100%;
  aspect-ratio: 1;
  display: flex;
  align-items: center;
